...
<!--#Meta:layouts/xedition/css/camera.css--><?php $__tmp=array('layouts/xedition/css/camera.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<!--#Meta:layouts/xedition/js/jquery.easing.js--><?php $__tmp=array('layouts/xedition/js/jquery.easing.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->_enable_slide){ ?><!--#Meta:layouts/xedition/js/camera.min.js--><?php $__tmp=array('layouts/xedition/js/camera.min.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
...
<!--#Meta:layouts/xedition/js/SmoothScroll.min.js--><?php $__tmp=array('layouts/xedition/js/SmoothScroll.min.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
					...
					<li class="hover">
						<?php if($__Context->is_logged){ ?>
							...
							<a href="<?php echo getUrl('act', 'dispMemberInfo') ?>" class="login_after">
								...
								<?php }else{ ?>
									<img src="/xe/layouts/xedition/img/ico_default.jpg" alt="<?php echo $__Context->logged_info->nick_name ?>" />
								<?php } ?>
							</a>
...
$__Context->_subheader_img = 'sub_banner_xeicon.jpg';
	...
	<?php if($__Context->layout_info->layout_type === 'main' && $__Context->_enable_slide){ ?><div class="visual">
			<!-- 슬라이드 -->
			...
			<?php }else{ ?>
				<?php if($__Context->layout_info->slide_img1){ ?><div data-src="<?php echo $__Context->layout_info->slide_img1 ?>">
					<?php if($__Context->layout_info->slide_text1){ ?><div class="camera_caption fadeIn">
						<div class="camera_caption_wrap">
							<?php echo $__Context->layout_info->slide_text1 ?>
						</div>
					</div><?php } ?>
				</div><?php } ?>
				<?php if($__Context->layout_info->slide_img2){ ?><div data-src="<?php echo $__Context->layout_info->slide_img2 ?>">
					<?php if($__Context->layout_info->slide_text2){ ?><div class="camera_caption fadeIn">
						<div class="camera_caption_wrap">
							<?php echo $__Context->layout_info->slide_text2 ?>
						</div>
					</div><?php } ?>
				</div><?php } ?>
				<?php if($__Context->layout_info->slide_img3){ ?><div data-src="<?php echo $__Context->layout_info->slide_img3 ?>">
					<?php if($__Context->layout_info->slide_text3){ ?><div class="camera_caption fadeIn">
						<div class="camera_caption_wrap">
							<?php echo $__Context->layout_info->slide_text3 ?>
						</div>
					</div><?php } ?>
				</div><?php } ?>
				<?php if($__Context->layout_info->slide_img4){ ?><div data-src="<?php echo $__Context->layout_info->slide_img4 ?>">
					<?php if($__Context->layout_info->slide_text4){ ?><div class="camera_caption fadeIn">
						<div class="camera_caption_wrap">
							<?php echo $__Context->layout_info->slide_text4 ?>
						</div>
					</div><?php } ?>
				</div><?php } ?>
				<?php if($__Context->layout_info->slide_img5){ ?><div data-src="<?php echo $__Context->layout_info->slide_img5 ?>">
					<?php if($__Context->layout_info->slide_text5){ ?><div class="camera_caption fadeIn">
						<div class="camera_caption_wrap">
