...
${'module251_argument'} = new Argument('module', $args->{'module'});
${'module251_argument'}->checkNotNull();
if(!${'module251_argument'}->isValid()) return ${'module251_argument'}->getErrorMessage();
if(${'module251_argument'} !== null) ${'module251_argument'}->setColumnType('varchar');
if(isset($args->module_category_srl)) {
${'module_category_srl252_argument'} = new Argument('module_category_srl', $args->{'module_category_srl'});
if(!${'module_category_srl252_argument'}->isValid()) return ${'module_category_srl252_argument'}->getErrorMessage();
} else
${'module_category_srl252_argument'} = NULL;if(${'module_category_srl252_argument'} !== null) ${'module_category_srl252_argument'}->setColumnType('number');
if(isset($args->layout_srl)) {
${'layout_srl253_argument'} = new Argument('layout_srl', $args->{'layout_srl'});
if(!${'layout_srl253_argument'}->isValid()) return ${'layout_srl253_argument'}->getErrorMessage();
} else
${'layout_srl253_argument'} = NULL;if(${'layout_srl253_argument'} !== null) ${'layout_srl253_argument'}->setColumnType('number');
if(isset($args->skin)) {
${'skin254_argument'} = new Argument('skin', $args->{'skin'});
if(!${'skin254_argument'}->isValid()) return ${'skin254_argument'}->getErrorMessage();
} else
${'skin254_argument'} = NULL;if(${'skin254_argument'} !== null) ${'skin254_argument'}->setColumnType('varchar');

${'is_skin_fix255_argument'} = new Argument('is_skin_fix', $args->{'is_skin_fix'});
${'is_skin_fix255_argument'}->ensureDefaultValue('N');
if(!${'is_skin_fix255_argument'}->isValid()) return ${'is_skin_fix255_argument'}->getErrorMessage();
if(${'is_skin_fix255_argument'} !== null) ${'is_skin_fix255_argument'}->setColumnType('char');
if(isset($args->mskin)) {
${'mskin256_argument'} = new Argument('mskin', $args->{'mskin'});
if(!${'mskin256_argument'}->isValid()) return ${'mskin256_argument'}->getErrorMessage();
} else
${'mskin256_argument'} = NULL;if(${'mskin256_argument'} !== null) ${'mskin256_argument'}->setColumnType('varchar');

${'is_mskin_fix257_argument'} = new Argument('is_mskin_fix', $args->{'is_mskin_fix'});
${'is_mskin_fix257_argument'}->ensureDefaultValue('N');
if(!${'is_mskin_fix257_argument'}->isValid()) return ${'is_mskin_fix257_argument'}->getErrorMessage();
if(${'is_mskin_fix257_argument'} !== null) ${'is_mskin_fix257_argument'}->setColumnType('char');
...
new UpdateExpression('`module`', ${'module251_argument'})
,new UpdateExpression('`module_category_srl`', ${'module_category_srl252_argument'})
,new UpdateExpression('`layout_srl`', ${'layout_srl253_argument'})
,new UpdateExpression('`skin`', ${'skin254_argument'})
,new UpdateExpression('`is_skin_fix`', ${'is_skin_fix255_argument'})
,new UpdateExpression('`mskin`', ${'mskin256_argument'})
,new UpdateExpression('`is_mskin_fix`', ${'is_mskin_fix257_argument'})
