...
${'site_srl287_argument'} = new ConditionArgument('site_srl', $args->site_srl, 'equal');
${'site_srl287_argument'}->checkNotNull();
${'site_srl287_argument'}->createConditionValue();
if(!${'site_srl287_argument'}->isValid()) return ${'site_srl287_argument'}->getErrorMessage();
if(${'site_srl287_argument'} !== null) ${'site_srl287_argument'}->setColumnType('number');
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl287_argument,"equal")))
));
